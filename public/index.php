...
<div id="content-left-wrapper">
  <div id="content-left">
    ...
    <div id="into"> 
      ...
      <div align="right">
      <a href="https://archlinux.com.ru/forum/viewtopic.php?p=145#p145" class="button" title="Кодекс поведения">
        <span>Кодекс поведения</span>
      </a>
        <a href="https://archlinux.com.ru/forum/ucp.php?mode=login&redirect=ucp.php?mode=register" class="button" title="Присоединяйтесь!">
    ...
    <div id="content-line">
      <div id="last-topic" class="main-box-left main-right">
        <h2><a href="https://archlinux.com.ru/forum/search.php?search_id=active_topics">Последние изменения на форуме:</a></h2>
        <ul>
        <?php main_get_rss("https://archlinux.com.ru/forum/feed/topics_active", "10"); ?>
        </ul>
      </div>
      <div id="news-topic" class="main-box-left">
        <h2><a href="https://archlinux.com.ru/forum/viewforum.php?f=49">Локальные новости:</a></h2>
        <ul>    
    ...
    <div id="content-line">
      <div id="last-blog" class="main-box-left main-right">
        <h2><a href="https://archlinux.com.ru/forum/viewforum.php?f=50">Статьи и публикации:</a></h2>
        <ul>
        <?php main_get_data_db('50','10'); ?>
        </ul>
      </div>
      <div id="gnews-topic" class="main-box-left">
        <h2><a href="https://archlinux.com.ru/forum/viewforum.php?f=56">Глобальные новости:</a></h2>
        <ul>    
...
<div id="content-right-wrapper">
  <div id="content-right">
    ...
    <div id="main-links" class="main-box-right">
      ...
      <h3>Сообщество:</h3>
      <ul>
        <li><a href="https://archlinux.com.ru/forum/viewtopic.php?p=145#p145">Кодекс поведения</a></li>
      </ul>
    </div>
